...
$sql = "SELECT * FROM skrill_deposit WHERE DATE(dt) = '$selected_date'";
$result = mysqli_query($conn, $sql);
...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
        <h2 class="text-center mt-5" style="color:white;">Skrill Deposit</h2>
        <form action="" method="get" class="mt-3">
            ...
            <a href="skrill_change.php"><button type="button" class="btn btn-danger" data-bs-toggle="modal" style="margin-left: 10px;">
  Change Fix Number
</button></a>
        </form>
        </div>
