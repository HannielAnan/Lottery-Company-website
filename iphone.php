...
$query = "SELECT amount FROM iphone_fixed_amounts WHERE id = 2";
...
if (isset($_POST['submit'])) {
  ...
  $sql = "SELECT COUNT(*) as count FROM form_motor_ban_number WHERE number = ?";
...
$sql = "INSERT INTO iphone (user_id, seven_digitiphone_number, amount, dt, user_name) VALUES (?, ?, ?, ?, ?)";
...
if ($result_car) {
    echo '<div class="alert alert-success" role="alert">Buying successfully.</div>';
} else {
...
<html lang="en">
  ...
  <body>
      ...
      <div class="row justify-content-center">
		...
		<h2 style="color: gold;">Enter Your lucky number to win an Iphone</h2>
		<form method="post">
