...
$query = "SELECT amount FROM motor_fixed_amounts WHERE id = 3";
...
$sql = "INSERT INTO motor (user_id, seven_digitmotor_number, amount, dt, user_name) VALUES (?, ?, ?, ?, ?)";
...
<html lang="en">
  ...
  <body>
      ...
      <div class="row justify-content-center">
		...
		<h2 style="color: gold;">Enter Your lucky number to win motor bike</h2>
		<form method="post">
