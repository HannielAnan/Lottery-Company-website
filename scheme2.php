...
if (isset($_POST['submit'])) {
  ...
  // Retrieve form data
  $six_digit_number = mysqli_real_escape_string($conn, $_POST['four_digit_number']);
  ...
  $sql = "SELECT COUNT(*) as count FROM form_2_ban_number WHERE number = ?";
  ...
  if ($ban_row['count'] > 0) {
    ...
    $sql = "INSERT INTO form_2 (user_id, four_digit_number, amount, result, dt, user_name) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($conn, $sql);
...
<html lang="en">
  ...
  <body>
      ...
      <div class="row justify-content-center">
		...
		<form method="post">
			<label for="four_digit_number">Four Digit Token:</label>
			<input type="text" name="four_digit_number" placeholder="Enter your number" pattern="\d{4}" maxlength="4" required>
			<br><br>
